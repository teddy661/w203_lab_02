...
> We expect that companies with high value assets (omitted variable) would be more attractive targets for criminals and may experience more security breaches (outcome variable), which means that the omitted variable has a positive effect on the outcome variable. We also expect high value assets to have a positive effect on cybersecurity training hours (measured variable), as companies with more valuable assets would seek to protect them through more cybersecurity training. Since the omitted variable has a positive effect on both the measured variable and the outcome variable, it will have a positive value. In addition, since the coefficient of cybersecurity training hour (measured variable) is positive, then, the bias of the omitted variable on the cybersecurity training hour is away from zero which is worse than those bias towards zero. This means that the true coefficient of cybersecurity training hours is less than 0.052 (which is very closed to 0); one posibility is that the true coefficient of cybersecurity training hours could be negative. Thus, we may not be able to trust the coefficient of cybersecurity training hours and the hypothesis test results.
...
(Linh's comment: I agree with the conclusion sentence but I disagreed with the graph above. For part 1, we argue that high value asset --(+)--\> Security breaches and high value asset --(+)--\> security breaches. In part 2, we argued that security breaches ---(+)--\> Training. In part 3, we argued that training ----\> Encripted and security breaches --\> Encripted. I think the figure above have too many arrows. I think we should just delete it).
