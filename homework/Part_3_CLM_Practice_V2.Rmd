...
- From the histogram and Q-Q plots of residual below, we observe that the errors are close to normal distribution, with slight thin tails (platykurtic). We also measured skewness and kurtosis of the errors, with skewness of 0.05738289 (within +-0.5 of zero, with zero being normal distribution) and kurtosis of 2.784654 (within +-0.5 of 3, with 3 being normal distribution), which confirms our observation from the graphs. Thus there is no strong evidence that this model violates the **Normally Distributed Errors** assumption. 
