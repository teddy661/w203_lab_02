...
ggplot(aes(x = predict(lm_video), y = resid(lm_video)))+
  geom_point() + stat_smooth() + labs( title = "residuals with respect to prediction")
```
