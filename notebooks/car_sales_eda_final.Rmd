...
vehicle_tier_boxplot <- ggplot(car_sales, aes(x = region, y = price_000)) +
  labs(title = "Price by Vehicle Tier", x = "Region", y = "Price in Thousands") +
  geom_boxplot(
...
complete_xy_plots <- ggarrange(
  ln_price_vs_ln_power_perf, ln_price_vs_ln_vehicle_size, ln_price_vs_vehicle_size, ln_price_vs_sqr_vehicle_size, ln_price_vs_hp_per_liter, ln_price_vs_region, ln_price_vs_weight
)
complete_xy_plots
```
