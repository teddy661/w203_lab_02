...
## Introduction 
With technology advancements, automobile manufacturers are fearful of being behind the curve and keen to invest in technology research and development (R&D) initiatives, to introduce or enhance vehicle models that provide better performance and driving experience to increase brand loyalty (retain customers) and attract new customers. Technology R&D spent is a key part of the total R&D cost for the automobile industry ($76 billions based on the 2000 McKinsey report\footnote{https://www.mckinsey.com/business-functions/strategy-and-corporate-finance/our-insights/building-an-r-and-d-strategy-for-modern-times}). It is critical for manufacturers to gauge how these technical advancements can generate the economic value and influence the vehicle price that consumers are willing to pay. Price is a key consideration to consumers when presented with factors to switch brands, as a consumer reports survey\footnote{https://www.consumerreports.org/cro/news/2010/05/survey-car-buyers-most-influenced-by-quality-and-fuel-economy/index.htm} in 2010 identified that price was an important factor to 67% of consumers surveyed. Therefore, pricing strategy is a key factor to the marketing success for launching vehicle models.  
...
Model 2 adds the Region variable and reflects US in the base model. Each region has have different engineering practices which may be reflected both in engine quality and the price (premium or discount) that manufacturers believe they can set for MSRP. Manufacturers from Asia and Europe have a positive effect on car price, in comparison to US manufacturers, which could be due to higher perceived engineering quality and precision. The coefficient of the Region variable is statistically significant (with p-value less than 0.001). To provide some context, for a hypothetical $30K car, Asian manufacturers have a positive effect on price by adding $1,980 (beta of 0.066 multiplied by $30K) to price, holding all other variables constant.
...
stargazer(car_price_base, car_base_size, car_size_curb,
  ...
  covariate.labels = c("Power Performance Ratio\\\\(in natural log)", "Power Performance At/Above Avg","Asian Manufacturer", "European Manufacturer", "Weight", "Constant"),
